...
# M4, try to incorporate repeated measures.
...
# data
bugs.data <- list(H1 = cbind(datSDB$logTesto1, datSDB$logTesto2),
                  H2 = cbind(datBDAPAN$logTesto1, datBDAPAN$logTesto2),
